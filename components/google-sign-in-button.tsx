...
export function GoogleSignInButton({ className }: { className?: string }) {
  ...
  return (
    <Button type="button" variant="outline" className={className ?? "mb-6 w-full"} disabled={pending} onClick={signIn}>
      <svg viewBox="0 0 24 24" className="size-4 shrink-0" aria-hidden="true" focusable="false">
        ...
        <path fill="#EA4335" d="M12 5.96c1.47 0 2.79.51 3.83 1.51l2.87-2.87A9.62 9.62 0 0 0 12 2a10 10 0 0 0-8.93 5.49l3.34 2.59C7.2 7.72 9.4 5.96 12 5.96Z" />
      </svg>
