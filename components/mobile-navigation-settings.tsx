          ...
          <div aria-label="Navbar preview" className={cn("bg-background/95 p-2", appearance.floating ? "rounded-2xl border shadow-lg shadow-black/5" : "border-y")}>
            <div className="flex h-16 items-center">
              <div className="flex min-w-0 flex-1 items-center overflow-x-auto">
                {chosen.map(page => (
                  <div key={page.href} title={page.title} className={cn("flex min-h-11 min-w-11 shrink-0 flex-1 flex-col items-center justify-center gap-1 rounded-lg px-3 py-2 text-muted-foreground", page.href === "/app/navigation" && "bg-primary/10 text-primary")}>
              ...
              <div className="flex min-h-11 w-16 shrink-0 flex-col items-center justify-center gap-1 text-muted-foreground">
